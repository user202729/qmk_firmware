...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [GAMING] = LAYOUT_georgi(
        ...
        TO(STENO_LAYER),  KC_LSFT, KC_Z,  KC_X,    KC_C,    KC_V,          KC_N,    KC_LEFT, KC_DOWN, KC_RIGHT, LGUI(KC_1), LGUI(KC_9),
    ...
    [GAMING_2] = LAYOUT_georgi(
        ...
        TO(GAMING),       KC_A,   KC_S,   KC_D,  KC_F,  KC_G,       KC_H,  KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT,
