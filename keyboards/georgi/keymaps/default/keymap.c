...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // Gaming layer (steno fallback)
    [GAMING] = LAYOUT_georgi(
        TO(STENO_LAYER),  KC_Q,   KC_W,   KC_E,  KC_R,  KC_T,       KC_Y,  KC_U,   KC_I,    KC_O,    KC_P,    KC_LBRC,
        TO(GAMING_2),     KC_A,   KC_S,   KC_D,  KC_F,  KC_G,       KC_H,  KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT,
                                          KC_1,  KC_C,  KC_V,       KC_N,  KC_M,   KC_2
    ),
	// True gaming layer
    [GAMING_2] = LAYOUT_georgi(
        TO(STENO_LAYER),  KC_ESC,  KC_W,  KC_A,    KC_S,    KC_D,          KC_6,    KC_7,    KC_UP,   KC_8,     KC_9,       KC_LGUI,
        TO(GAMING),       KC_LSFT, KC_Z,  KC_X,    KC_C,    KC_V,          KC_N,    KC_LEFT, KC_DOWN, KC_RIGHT, LGUI(KC_1), LGUI(KC_9),
                                          KC_LALT, KC_SPC,  KC_SPC,        KC_DEL,  KC_ASTR, TO(STENO_LAYER)
    )
};
